...
#End If
        ...
        End Function
          ...
          Function GetOrCreate(ByVal key1 As TKey1, ByVal key2 As TKey2, ByVal key3 As TKey3, ByVal valueFunction As Func(Of TKey1, TKey2, TKey3, TValue)) As TValue
        ...
        End Function
          ...
          Function GetOrCreate(ByVal key1 As TKey1, ByVal key2 As TKey2, ByVal key3 As TKey3, ByVal defaultValue As TValue) As TValue
