...
#If IncludeUntested Then
    ...
    Public Structure FlexDate
        ...
        Public Shared Function FromYearMonthDay(ByVal year As Integer, ByVal month As Integer, ByVal day As Integer) As FlexDate
        ...
        Public Shared Function FromYearMonthWeek(ByVal year As Integer, ByVal month As Integer, ByVal week As Integer) As FlexDate
            Dim result As New FlexDate
            result.m_Year = year
            result.m_Month = month
        ...
        Public Shared Function FromYearMonth(ByVal year As Integer, ByVal month As Integer) As FlexDate
            Dim result As New FlexDate
            result.m_Year = year
            result.m_Month = month
            result.m_DateMode = FlexDateParts.YearMonthWeek
        ...
        Public Shared Function FromYearQuarter(ByVal year As Integer, ByVal quarter As Integer) As FlexDate
            Dim result As New FlexDate
            result.m_Year = year
        ...
        Public Shared Function FromYear(ByVal year As Integer) As FlexDate
            Dim result As New FlexDate
            result.m_Year = year
        ...
        Public ReadOnly Property DateParts() As FlexDateParts
            Get
                Return m_DateMode
            End Get
        End Property
        ...
        Public ReadOnly Property WeekOfMonth() As Integer?
            Get
