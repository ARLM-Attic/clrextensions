...
Public Module ColorExtension
	...
	''' <returns></returns>
	''' <remarks></remarks>
	Public Function FromHsl(ByVal hue As Single, ByVal saturation As Single, ByVal lightness As Single) As Drawing.Color
		'todo : Check ranges
		Dim q As Single
	...
	Public Function FromHsv(ByVal hue As Single, ByVal saturation As Single, ByVal value As Single) As Drawing.Color
		'todo : Check ranges
