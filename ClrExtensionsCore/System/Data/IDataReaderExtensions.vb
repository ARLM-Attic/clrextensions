...
#Region "Nullable methods, by name"
    ...
    <Untested()> <Extension()> Public Function GetBooleanSafe(ByVal this As IDataRecord, ByVal name As String) As Boolean?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetBoolean(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetByteSafe(ByVal this As IDataRecord, ByVal name As String) As Byte?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetByte(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetCharSafe(ByVal this As IDataRecord, ByVal name As String) As Char?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetChar(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetDateTimeSafe(ByVal this As IDataRecord, ByVal name As String) As Date?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetDateTime(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetDecimalSafe(ByVal this As IDataRecord, ByVal name As String) As Decimal?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetDecimal(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetDoubleSafe(ByVal this As IDataRecord, ByVal name As String) As Double?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetDouble(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetFloatSafe(ByVal this As IDataRecord, ByVal name As String) As Single?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetFloat(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetGuidSafe(ByVal this As IDataRecord, ByVal name As String) As Guid?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetGuid(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetInt16Safe(ByVal this As IDataRecord, ByVal name As String) As Short?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetInt16(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetInt32Safe(ByVal this As IDataRecord, ByVal name As String) As Integer?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetInt32(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetInt64Safe(ByVal this As IDataRecord, ByVal name As String) As Long?
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetInt64(this.GetOrdinal(name))
    End Function

    <Untested()> <Extension()> Public Function GetStringSafe(ByVal this As IDataRecord, ByVal name As String) As String
        If this.IsDBNull(name) Then Return Nothing
        Return this.GetString(this.GetOrdinal(name))
    End Function
...
#Region "Nullable methods, by ordinal"
    <Untested()> <Extension()> Public Function GetBooleanSafe(ByVal this As IDataRecord, ByVal i As Integer) As Boolean?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetBoolean(i)
    End Function

    <Untested()> <Extension()> Public Function GetByteSafe(ByVal this As IDataRecord, ByVal i As Integer) As Byte?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetByte(i)
    End Function

    <Untested()> <Extension()> Public Function GetCharSafe(ByVal this As IDataRecord, ByVal i As Integer) As Char?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetChar(i)
    End Function

    <Untested()> <Extension()> Public Function GetDateTimeSafe(ByVal this As IDataRecord, ByVal i As Integer) As Date?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetDateTime(i)
    End Function

    <Untested()> <Extension()> Public Function GetDecimalSafe(ByVal this As IDataRecord, ByVal i As Integer) As Decimal?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetDecimal(i)
    End Function

    <Untested()> <Extension()> Public Function GetDoubleSafe(ByVal this As IDataRecord, ByVal i As Integer) As Double?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetDouble(i)
    End Function

    <Untested()> <Extension()> Public Function GetFloatSafe(ByVal this As IDataRecord, ByVal i As Integer) As Single?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetFloat(i)
    End Function

    <Untested()> <Extension()> Public Function GetGuidSafe(ByVal this As IDataRecord, ByVal i As Integer) As Guid?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetGuid(i)
    End Function

    <Untested()> <Extension()> Public Function GetInt16Safe(ByVal this As IDataRecord, ByVal i As Integer) As Short?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetInt16(i)
    End Function

    <Untested()> <Extension()> Public Function GetInt32Safe(ByVal this As IDataRecord, ByVal i As Integer) As Integer?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetInt32(i)
    End Function

    <Untested()> <Extension()> Public Function GetInt64Safe(ByVal this As IDataRecord, ByVal i As Integer) As Long?
        If this.IsDBNull(i) Then Return Nothing
        Return this.GetInt64(i)
    End Function

    <Untested()> <Extension()> Public Function GetStringSafe(ByVal this As IDataRecord, ByVal i As Integer) As String
        If this.IsDBNull(i) Then Return Nothing
