...
Module StreamExtension
	...
	''' <returns></returns>
	''' <remarks></remarks>
	<Untested()> <Extension()> Function ToStreamReader(ByVal source As Stream, ByVal encoding As Text.Encoding) As StreamReader
	...
	''' <returns></returns>
	''' <remarks></remarks>
	<Untested()> <Extension()> Function ToStreamWriter(ByVal source As Stream, ByVal encoding As Text.Encoding) As StreamWriter
