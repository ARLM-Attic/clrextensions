...
Public Module ActionExtensions
    ...
    ''' <remarks></remarks>
    <Untested()>
    <Extension()> Public Sub Repeat(ByVal action As Action, ByVal occurrences As Integer)
    ...
    <Untested()>
    <Extension()> Public Sub Repeat(ByVal action As Action(Of Integer), ByVal occurrences As Integer)
        If action Is Nothing Then Throw New ArgumentNullException("action")
        For i = 1 To occurrences
            action.Invoke(i)
        Next
