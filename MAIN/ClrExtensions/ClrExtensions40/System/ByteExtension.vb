...
Public Module ByteExtension
    ...
    <Extension()> Function ToString(ByVal source As IEnumerable(Of Byte), ByVal format As String, ByVal groupingSize As Integer) As String
        ...
        Dim result = If(temp Is Nothing, New StringBuilder(), New StringBuilder(temp.Count * format.Length))
    ...
    <Extension()> Function ToString(ByVal source As IEnumerable(Of Byte), ByVal encoding As Encoding) As String
